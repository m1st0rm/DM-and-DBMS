...
<body>
    ...
    <ol>
        ...
        <li>
            ...
            <ul>
                <li>Пользователи могут искать книги по различным критериям (автор, жанр и т.д.).</li>
        ...
        <li>
            <h3>Уведомления:</h3>
            <ul>
                <li>Система предоставляет уведомления пользователям о их текущем состоянии.</li>
            </ul>
        </li
    </ol>
